object fRListaChofer: TfRListaChofer
  Left = 260
  Top = 129
  Width = 1021
  Height = 579
  Caption = 'fRListaChofer'
  Color = clBtnFace
  ...
  object RListaChofer: TQuickRep
    ...
    object Bandtitulo: TQRBand
      ...
      object qrlTitulo1: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'LISTADO GENERAL DE CHOFERES'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -15
  ...
  object qryChoferL: TMyQuery
    Connection = fPrincipal.MyConnectT
    SQL.Strings = (
      'select * from Choferes order by cod_chofer')
    Active = True
    FetchAll = True
    Left = 59
  end
