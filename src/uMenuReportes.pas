...
begin
   ...
   fProduccionE.Caption:='Reporte de Producción por Equipo';
end;
...
begin
   ...
   fProduccionE.Caption:='Relación de Gastos de Mantenimiento';
end;
...
begin
   ...
   fProduccionE.Caption:='Relación de Gastos de Combustible';
end;
